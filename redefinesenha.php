<?php
	...
	//include('class.phpmailer.php'); //chama a classe de onde você a colocou.
	...
	$mail->SMTPAuth = true; 
	$mail->Username = 'kassio.lima.p@gmail.com'; // usuario gmail.   
	$mail->Password = 'kassio27820544'; // senha do email.

	$mail->SingleTo = true; 

	// configuração do email a ver enviado.
	$mail->From = "kassio.lima.p@gmail.com"; 

	$mail->FromName = "Ilha dos Brinquedos";
	...
	if((isset($_POST['cpf'])) && (!empty($_POST['cpf'])))
	{
		...
		else
		{
			...
			{
				if (($_POST['cpf'] == $row['cpf']))
				{
					$mail->addAddress($row['email']); // email do destinatario.
					...
					$result = mysqli_query($con, "SELECT cod from redefinicao_de_senha where cod = '$cod'");
					...
					mysqli_query($con, "INSERT INTO redefinicao_de_senha (cod, cpf, data_hora) VALUES ('$cod','$_POST[cpf]', '$datahora')");

					$link = "http://localhost/xampp/ilhadosbrinquedos/?pg=redefinir&cod=".$cod;


					$mail->Body = 
					"
						<h1 style='font-size: 130%; font-weight: normal;'>
							Foi solicidada uma redefinição de senha em sua conta.<br>Para confirmar <a href='".$link."'>clique aqui</a>
						</h1>
					";
					...
					header("location: ../ilhadosbrinquedos/?pg=enviado");
				}
				else
				{
					$erro = "erro_no_cpf";
	...
	if(isset($erro)) 
	{
		header("location: ../ilhadosbrinquedos/?pg=esqueci&erro=".$erro);
	}
?>