<?php
	...
	$mail->addAddress($_SESSION['emailconf']); // email do destinatario.

	$mail->Subject = "Redefinição de senha"; 
	$mail->Body = "
	<h1 style='font-size: 130%; font-weight: normal;'>
		Seu código de acesso em <a href='#'>Ilha dos Brinquedos</a> foi redefinido com sucesso!
		<br><br>
		Seu código de acesso é <br><b style='font-size: 140%;'>".$_SESSION['codconf']."</b>
		<br><br>
		<b>Anote!</b> É ele que voce vai usar para fazer login.
	</h1>";
